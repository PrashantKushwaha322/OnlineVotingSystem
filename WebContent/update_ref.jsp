...
background-color: white; 
	...
	<body>
		...
		<form action="#">
			<font size='5pxl'>Select Employee Id for update :<select name="ids">
				...
				<form action="updateSrv" method="post">
					...
					<input type="hidden" name="pwd"	value="<%=rss.getString(7) %>"><br>
						...
						<%--Checkbox business --%>
							...
							<% //}//close of while
							%><br>
					<button class="button button3">	<input class="button" type="submit" value="Update" name="action"></button>
						<%
							}//close of action check if for search
					}//close of rss check if
			} //close of id check if				
